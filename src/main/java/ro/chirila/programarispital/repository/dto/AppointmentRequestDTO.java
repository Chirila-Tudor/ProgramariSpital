...
public class AppointmentRequestDTO {
    ...
    @NotBlank(message = "Please choose a date of birth.")
    private String dateOfBirth;
    @NotBlank(message = "Please choose the date of the appointment.")
    private String chooseDate;
    @NotBlank(message = "Please choose the appointment hour.")
